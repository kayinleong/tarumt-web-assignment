                        ...
                        <div class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="mt-3 flex items-center">
                                    <input name="status" id="status" type="checkbox" value="on" <?php echo $user['status'] == 'S' ? "checked" : "" ?> class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
