...
if (isset($_POST['sub']) && $_POST['sub'] === 'Update') {
    ...
    if (empty($errors)) {
        ...
        $sql = "UPDATE movies SET name = '$name', description = '$description', pic_url = '$newImageName' WHERE id = $id";
        $con->query($sql);
                        ...
                        <div class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                            <form id="update_form" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="<?php echo $movie['name'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name">
                                </div>

                                <div class="mt-3">
                                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                    <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Description"><?php echo $movie['description'] ?></textarea>
                                </div>
                                ...
                                <div class="mt-3">
                                    <figure class="max-w-sm mx-auto">
                                        <img class="h-auto max-w-full rounded-lg" src="/assignment/wwwroot/images/movies/<?php echo $movie['pic_url'] ?>" alt="image description">
                                        <figcaption class="mt-2 text-center">
                                            <i><?php echo $movie['pic_url'] ?></i>
                                        </figcaption>
                                    </figure>

                                    <label class="block my-2 text-sm font-medium text-gray-900 dark:text-white" for="image">Upload Image</label>
                                    <input type="file" id="image" name="image" value="<?php echo $movie['pic_url'] ?>" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                                </div>
